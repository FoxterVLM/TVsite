    ...
    <div className="review-add mb-[50px]">
      ...
      >
        <div className="nickname flex flex-col text-white gap-2">
          ...
          />
          {errors.nickname && (
            <p className="text-red-500 -mt-4">{errors.nickname.message}</p>
          )}
        </div>
        ...
        <div className="country flex flex-col text-white gap-2">
          ...
          />
          {errors.country && (
            <p className="text-red-500 -mt-4">{errors.country.message}</p>
          )}
        </div>
        ...
        <div className="rating flex flex-col text-white gap-2">
          ...
          />
          {errors.rating && (
            <p className="text-red-500 -mt-4">{errors.rating.message}</p>
          )}
        </div>
        ...
        <div className="review-text flex flex-col text-white gap-2">
          ...
          />
          {errors.text && (
            <p className="text-red-500 -mt-4 max-w-[200px]">
              {errors.text.message}
            </p>
          )}
        </div>
        <button className="form-submit bg-[#E50000] max-w-[200px] rounded-[12px] p-[10px] text-white font-medium cursor-pointer hover:scale-105 transition-500 ease-in-out">
          Publish Review
        </button>
        <button
          className="form-cancel bg-[#999999] max-w-[200px] rounded-[12px] p-[10px] text-white font-medium cursor-pointer hover:scale-105 transition-500 ease-in-out"
